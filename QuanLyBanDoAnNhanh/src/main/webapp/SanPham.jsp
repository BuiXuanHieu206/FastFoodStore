                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="SanPhamController" class="nav-item nav-link active">Sản phẩm</a>
                                    ...
                                    <div class="col-lg-12">
                                    	<form action="SanPhamController" method="post">
	                                        <div class="mb-3">
	                                            ...
	                                            <c:choose>
	                                            	<c:when test="${boloc!=null }">
	                                            		<output id="amount" name="amount" min-value="0" max-value="500000" for="rangeInput">${boloc}</output>
	                                            	</c:when>
	                                            	<c:otherwise>
	                                            		<output id="amount" name="amount" min-value="0" max-value="500000" for="rangeInput">0</output>
	                                            	</c:otherwise>
	                                            </c:choose>
	                                            <button type="submit" class="btn border border-secondary px-4 py-3 rounded-pill text-primary w-100">Lọc</button>
	                                        </div>
                                       	</form>
                                    </div>
                                    <div class="col-lg-12">
                                        ...
                                        <c:forEach items="${spMoi}" var="spMoi">
                                        	<div class="d-flex align-items-center justify-content-start">
	                                            <div class="rounded me-4" style="width: 100px; height: 100px;">
	                                                <img src="${spMoi.getAnh()}" class="img-fluid rounded" alt="">
	                                            </div>
	                                            <div>
	                                                <h6 class="mb-2">${spMoi.getTenMon()}</h6>
	                                                <div class="d-flex mb-2">
	                                                    <h6 class="fw-bold me-2">${spMoi.getGia()} ₫</h6>
	                                                    <h6 class="text-danger text-decoration-line-through">${spMoi.getGia()+5000} ₫</h6>
	                                                </div>
	                                            </div>
	                                        </div>
                                        </c:forEach>
		                                		...
		                                		<div class="col-md-6 col-lg-6 col-xl-4">
			                                        <div class="rounded position-relative fruite-item">
			                                            <div class="fruite-img">
			                                                <img src="${mon.getAnh()}" class="img-fluid w-100 rounded-top" alt="">
			                                            </div>
			                                            <c:forEach items="${dsloai}" var="loai">
			                                                <c:if test="${mon.getMaLoai().equals(loai.getMaLoai())}">
