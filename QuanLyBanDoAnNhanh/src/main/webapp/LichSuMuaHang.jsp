        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
	            <c:choose>
		                        ...
		                        <tbody>
		                       		<c:forEach items="${lsmh}" var="ls">
		                      			<tr>
			                                ...
			                                <td class="text-center">
			                                    <p class="mb-0 mt-4">${ls.getNgayMua()}</p>
			                                </td>
			                                <c:choose>
			                                	<c:when test="${ls.isDaMua()==true}">
			                                		<td class="text-center" style="color: #81c408">
					                                    <i><p class="mb-0 mt-4">Đã thanh toán</p></i>
					                                </td>
			                                	</c:when>
			                                	<c:otherwise>
			                                		<td class="text-center text-danger">
					                                    <i><p class="mb-0 mt-4">Chờ xác nhận</p></i>
					                                </td>
			                                	</c:otherwise>
			                                </c:choose>
			                            </tr>
	                ...
	                <c:otherwise>
	                	<p class="text-center"><i>Hiện chưa có lịch sử mua hàng. Đến mua hàng tại mục <a href="SanPhamController">Sản phẩm</a></i></p>
	                </c:otherwise>
                </c:choose>
            </div>
        </div>
