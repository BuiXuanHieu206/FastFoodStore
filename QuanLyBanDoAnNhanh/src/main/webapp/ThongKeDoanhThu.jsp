...
<html>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Thống kê doanh thu</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item active text-white">Thống kê doanh thu</li>
            </ol>
        </div>
                         	...
                         	<div class="was-validated">
                         		<c:choose>
                         			<c:when test="${title!=null}">
                         				<h3 class="mb-4 text-primary text-center">THỐNG KÊ DOANH THU ${title}</h3>
                         			</c:when>
                         			<c:otherwise>
                         				<h3 class="mb-4 text-primary text-center">THỐNG KÊ DOANH THU</h3>
                         			</c:otherwise>
                         		</c:choose>
                   				<h5 class="mb-2">Tổng doanh thu</h5>
                   				<input type="text" class="w-100 form-control border-0 py-3 mb-4" value="${tongdoanhthu} đồng" readonly>
                           	</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5">
            	<div class="row g-4 mb-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-9">
                                <form action="ThongKeDoanhThuController" method="post">
                                	<div class="d-flex">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                       		<c:forEach items="${dsdt}" var="dt">
                      			<tr>
                      				<td class="text-center">
	                                    <p class="mb-0 mt-4">${dt.getMaLoai()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dt.getTenLoai()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dt.getTongSoLuong()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dt.getTongDoanhThu()}</p>
	                                </td>
	                            </tr>
                       		</c:forEach>
                        </tbody>
