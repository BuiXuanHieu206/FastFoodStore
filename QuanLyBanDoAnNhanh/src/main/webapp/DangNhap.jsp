                    ...
                    <div class="row g-4">
                        <div class="col-lg-7">
                            <form action="DangNhapController" method="post">
                                ...
                                <button class="w-100 btn form-control border-secondary py-3 bg-white" type="submit">Đăng nhập</button>
                                <div style="text-align: center;">
	                                Bạn chưa có tài khoản? <a href="DangKyController">Đăng ký ngay</a>
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-5">
