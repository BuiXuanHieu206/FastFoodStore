    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item"><a href="ThongKeDonHangController">Thống kê đơn hàng</a></li>
            ...
            <div class="container py-5">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                       		<c:forEach items="${ctdh}" var="dh">
                      			<tr>
                      				<td class="text-center">
	                                    <p class="mb-0 mt-4">${dh.getMaCTDH()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dh.getTenMon()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dh.getGia()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dh.getSoLuongMua()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dh.getThanhTien()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${dh.getNgayMua()}</p>
	                                </td>
	                                <td class="text-center">
	                                	<c:choose>
		                                	<c:when test="${dh.isDaMua()==true}">
		                                		<i><p class="mb-0 mt-4 text-primary">Đã thanh toán</p></i>
		                                	</c:when>
		                                	<c:otherwise>
