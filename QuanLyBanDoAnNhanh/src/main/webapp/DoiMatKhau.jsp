        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                        <div class="col-lg-7">
                            <form action="DoiMatKhauController?tendn=${tk.getTenDN()}" method="post">
                            	<div class="was-validated">
	                                <input type="password" class="w-100 form-control border-0 py-3 mb-4" placeholder="Mật khẩu" name="txtMatKhau" required>
	                                <input type="password" class="w-100 form-control border-0 py-3 mb-4" placeholder="Mật khẩu mới" name="txtMatKhauMoi" required>
                            		<input type="password" class="w-100 form-control border-0 py-3 mb-4" placeholder="Nhập lại mật khẩu" name="txtNLMatKhau" required>
                            	</div>
                                <c:choose>
									<c:when test="${tb!=null }">
                                ...
                                <button class="w-100 btn form-control border-secondary py-3 bg-white" type="submit">Đổi mật khẩu</button>
                            </form>
                        </div>
                        <div class="col-lg-5">
