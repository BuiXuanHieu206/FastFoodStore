...
<html>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Quản lý loại</h1>
        ...
        <div class="container-fluid contact pt-5">
            <div class="container-sm pt-5">
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                    	<form action="QuanLyLoaiController" method="post">
	                        <div class="col-lg-12">
	                           	<div class="was-validated">
	                           		<h3 class="mb-4 text-primary text-center">THÔNG TIN LOẠI</h3>
	                           		<c:choose>
	                           			<c:when test="${loai!=null}">
	                           				<h5 class="mb-2">Mã loại</h5>
	                           				<input type="text" class="w-100 form-control border-0 py-3 mb-4" value="${loai.getMaLoai()}" placeholder="Mã loại" name="txtMaLoai" readonly>
	                           				<h5 class="mb-2">Tên loại</h5>
	                           				<input type="text" class="w-100 form-control border-0 py-3 mb-4" value="${loai.getTenLoai()}" placeholder="Tên loại" name="txtTenLoai" required>
	                           			</c:when>
	                           			<c:otherwise>
	                           				<h5 class="mb-2">Mã loại</h5>
	                           				<input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Mã loại" name="txtMaLoai" required>
			                                <h5 class="mb-2">Tên loại</h5>
			                                <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Tên loại" name="txtTenLoai" required>
	                           			</c:otherwise>
	                           		</c:choose>
	                           	</div>
	                            <c:if test="${tb!=null}">
            	...
            	<div class="row g-4 mb-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
                                <form action="QuanLyLoaiController" method="post">
                                	<div class="input-group w-100 mx-auto d-flex">
			                            <input name="txttk" type="search" class="form-control p-3" placeholder="Tên loại" aria-describedby="search-icon-1" required>
                            ...
                            <div class="col-xl-3">
                            	<form action="QuanLyLoaiController" method="post">
                                	<input type="submit" name="tcl" value="Tất cả loại" class="w-100 btn form-control border-secondary py-3 me-5 bg-white">
                            	</form>
                            </div>
                        </div>
                	</div>
                       		...
                       		<c:forEach items="${dsloai}" var="l">
                      			<tr>
                      				<td class="text-center">
	                                    <p class="mb-0 mt-4">${l.getMaLoai()}</p>
	                                </td>
	                                <td class="text-center">
	                                    <p class="mb-0 mt-4">${l.getTenLoai()}</p>
	                                </td>
	                                <form action="QuanLyLoaiController" method="post">
		                                <td class="text-center">
		                                	<button class="btn btn-md rounded-circle bg-light border mt-4" value="${l.getMaLoai()}" name="btnSua">
